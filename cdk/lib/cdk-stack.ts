...
export class CdkStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
   ...
   // Add bucket policy to allo Cloudfront access
    ...
    // Redirect S3 bucket for www.tonythomasm.com
    // const redirectBucket = new s3.Bucket(this, 'RedirectWebsiteBucket', {
    //   bucketName: 'www.tonythomasm.com',
    //   websiteRedirect: {
    //     hostName: 'tonythomasm.com',
    ...
    const distribution = new cloudfront.CloudFrontWebDistribution(this, 'StaticWebsiteDistribution', {
      ...
      viewerCertificate: {
        aliases: ['tonythomasm.com', 'www.tonythomas.com'],
        props: {
